...
class TeacherHome extends StatelessWidget {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _menuCard(icon: Icons.bar_chart_rounded, label: 'Class Performance', subtitle: 'View all students\' progress', color: const Color(0xFFFFAB40)),
                  const SizedBox(height: 12),
                  _menuCard(icon: Icons.assignment_rounded, label: 'Assign Module', subtitle: 'Set tasks for students', color: const Color(0xFFFF8FAB)),
                  const SizedBox(height: 12),
                  _menuCard(icon: Icons.group_rounded, label: 'Manage Students', subtitle: 'View and manage student list', color: const Color(0xFF4DD9C0)),
                  const SizedBox(height: 24),
                  SizedBox(
  ...
  Widget _menuCard({required IconData icon, required String label, required String subtitle, required Color color}) {
    return Container(
      width: double.infinity,
